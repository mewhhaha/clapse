...
async function run() {
  ...
  try {
    ...
    const unsupportedCases = [
      ...
      {
        name: "unsupported_and_named_helper_shape",
        source: [
          'import "prelude" { and }',
          "",
          "export { main }",
      ...
      {
        name: "unsupported_not_named_helper_shape",
        source: [
          'import "prelude" { not }',
          "",
          "export { main }",
      ...
      {
        name: "unsupported_implies_named_helper_shape",
        source: [
      ...
      {
        name: "unsupported_append_list_without_alternative_instance",
        source: [
          ...
          "",
          "main =",
          "  case append (Cons 201 Nil) (Cons 1 Nil) of",
          "    Cons x _ -> x",
          "    _ -> 0",
          "",
        ].join("\n"),
      ...
      {
        name: "unsupported_alt_operator_list_without_alternative_instance",
        source: [
          ...
          "",
          "main =",
          "  case ((Cons 201 Nil) <|> (Cons 1 Nil)) of",
          "    Cons x _ -> x",
          "    _ -> 0",
          "",
        ].join("\n"),
